...
int main(int argc, char** argv)
{
     ...
     * 功能：使能机器人
     ******************************/
    ros::ServiceClient client = nh.serviceClient<MG400Robot::EnableRobot>("enableRobot");    // 创建服务
    MG400Robot::EnableRobot srv;    // 消息类型enableRobot.srv
    ...
    ros::ServiceClient client = nh.serviceClient<MG400Robot::DisableRobot>("DisableRobot");    // 创建服务
    MG400Robot::DisableRobot srv;    // 消息类型disableRobot.srv
    client.call(srv);                // 发布服务
    ROS_INFO("Result: %d", srv.response.res);
    ...
    ros::ServiceClient client = nh.serviceClient<MG400Robot::DO>("DO");
    MG400Robot::DO srv;
    int index, status;
    ...
    ros::ServiceClient client = nh.serviceClient<MG400Robot::AccJ>("AccJ");
    MG400Robot::AccJ srv;
    int R1;
    srv.request.r = R1;
    client.call(srv);
    ...
    ros::ServiceClient client = nh.serviceClient<MG400Robot::SetArmOrientation>("SetArmOrientation");
    MG400Robot::SetArmOrientation srv;
     ...
     * 功能：运行lua脚本。
     ******************************/
    ros::ServiceClient client = nh.serviceClient<MG400Robot::RunScript>("RunScript");
    MG400Robot::RunScript srv;
    std::string name;
     ...
     ******************************/
    ros::ServiceClient client = nh.serviceClient<MG400Robot::PositiveSolution>("PositiveSolution");
    MG400Robot::PositiveSolution srv;
    double J1, J2, J3, J4;
    int User, Tool;
     ...
     ******************************/
    ros::ServiceClient client = nh.serviceClient<MG400Robot::InverseSolution>("InverseSolution");
    MG400Robot::InverseSolution srv;
#ifdef
    double J1, J2, J3, J4;
    int User, Tool;
     ...
     * 功能：创建modbus主站
     ******************************/
    ros::ServiceClient client = nh.serviceClient<MG400Robot::ModbusCreate>("ModbusCreate");
    MG400Robot::ModbusCreate srv;
#ifdef
    std::string ip;
     ...
     * 功能：读保持寄存器。
     ******************************/
    ros::ServiceClient client = nh.serviceClient<MG400Robot::GetHoldRegs>("GetHoldRegs");
    MG400Robot::GetHoldRegs srv;
#ifdef
     ...
     ******************************/
    ros::ServiceClient client = nh.serviceClient<MG400Robot::DOGroup>("DOGroup");
    MG400Robot::DOGroup srv;
#ifdef
     ...
     ******************************/
    ros::ServiceClient client = nh.serviceClient<MG400Robot::MovL>("MovL");
    MG400Robot::MovL srv;
#ifdef
    double x, y, z, r;
    srv.request.x = x;
    ...
    ​		该指令需结合其他运动指令确定圆弧起始点。
     ******************************/
    ros::ServiceClient client = nh.serviceClient<MG400Robot::Arc>("Arc");
    MG400Robot::Arc srv;
#ifdef
    double x1, y1, z1, r1;
    double x2, y2, z2, r2;
     ...
     ******************************/
    ros::ServiceClient client = nh.serviceClient<MG400Robot::MovLIO>("MovLIO");
    MG400Robot::MovLIO srv;
#ifdef
    double x, y, z, r;
     ...
     * 功能：点动运动，不固定距离运动
     ******************************/
    ros::ServiceClient client = nh.serviceClient<MG400Robot::MoveJog>("MoveJog");
    MG400Robot::MoveJog srv;
#ifdef
    std::string axisID;
     ...
     * 功能：整圆运动，仅对笛卡尔点位生效。
     ******************************/
    ros::ServiceClient client = nh.serviceClient<MG400Robot::Circle>("Circle");
    MG400Robot::Circle srv;
#ifdef
    double x1, y1, z1, r1;
    double x2, y2, z2, r2;
    int count;
